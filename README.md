...
3. Gree chose a strange implementation or it is a bug in firmware: if AC unit can't connect to Gree servers on internet ( or fake server ) I seen on AP log that it will reconnect to WIFI-SSID every 15s... what a bummer, they really succeed to make the unit unusable and to overload your wifi for no reason. :(
